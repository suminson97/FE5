...
const value2 = "one"; //없는값 시 defalut 실행
...
const value3 = "two"; //없는값 시 defalut 실행
...
switch (new Date().getDay()) {
  ...
  case 6:
    console.log("토요일");
    break;
  //   default 는 경고한 코드를 위해서 써주시는 편이 좋습니다.
}
// 여러줄 복사하고 싶을 때에
...
//널리쉬 연산자 사용
console.log(요일객체2[요일2] ?? "hello"); // console.log(undefined ?? 'hello')
